...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(self, x, emb, context=None, temporal_context=None, batch_size=None):
        for layer in self:
...
class UNetModel(nn.Module):
    ...
    def __init__(self,
        ...
        # init_attn_self_att_only = True # hard cord!!!
        # middle_blk_self_att_only= True # hard cord!!!
    ...
    def forward(self, x, timesteps, context=None, temporal_context=None, features_adapter=None, fs=None, **kwargs):
        b,_,t,_,_ = x.shape
        ...
        for id, module in enumerate(self.input_blocks):
            h = module(h, emb, context=context, temporal_context=temporal_context, batch_size=b)
            if id ==0 and self.addition_attention:
                h = self.init_attn(h, emb, context=context, temporal_context=temporal_context, batch_size=b)
        ...
        h = self.middle_block(h, emb, context=context, temporal_context=temporal_context, batch_size=b)
